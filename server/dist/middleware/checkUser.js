...
function checkUser(req, res, next) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var token, jwtData, id, projectKey, deta, vocabularySet, username, vocabularySetData, err_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    id = (_a = req.body.oldKey) !== null && _a !== void 0 ? _a : req.body.key;
                    projectKey = process.env.PROJECT_KEY;
                    deta = (0, deta_1.Deta)(projectKey);
                    vocabularySet = deta.Base("vocabulary-sets");
                    username = jwtData.username;
                    return [4, vocabularySet.get(id)];
                case 1:
                    vocabularySetData = _b.sent();
